...
<div class="row">
    <div class="col s12 m12 l12 ">
        <div class="card-panel z-depth-2 ">
            ...
            <div class="row">
                <form class="col s6 offset-m3" action="QA-user.php" method="post">
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <select class="browser-default" name="country">
                                ...
                                <option value="Holy See (Vatican City State)" title="Holy See (Vatican City State)">Holy
                                ...
                                <option value="Saint Pierre and Miquelon" title="Saint Pierre and Miquelon">Saint Pierre
                                    and Miquelon
                                </option>
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <select class="browser-default" name="category">
                                    ...
                                    <option value="Alternative dispute resolution Law">Alternative dispute resolution
                                        Law
                                    </option>
                                    <option value="Animal Law">Animal Law</option>
                                    <option value="Antitrust Law">Antitrust Law</option>
                                    <option value="Art & Culture Law">Art & Culture Law</option>
                                    <option value="Aviation Law">Aviation Law</option>
                                    <option value="Bank Law">Bank Law</option>
                                    <option value="Bankruptcy Law">Bankruptcy Law</option>
                                    <option value="Bioethics Law">Bioethics Law</option>
                                    <option value="Business Law">Business Law</option>
                                    <option value="Business Organization Law">Business Organization Law</option>
                                    <option value="Child Abuse and Neglect Law">Child Abuse and Neglect Law</option>
                                    <option value="Civil Law">Civil Law(Common Law)</option>
                                    ...
                                    <option value="Educational Law">Educational Law</option>
                                    <option value="Elder Law">Elder Law</option>
                                    <option value="Employment Law">Employment Law</option>
                                    <option value="Energy Law">Energy Law</option>
                                    <option value="Entertainment Law">Entertainment Law</option>
                                    <option value="Family Law">Family Law</option>
                                    <option value="Financial Services Regulation Law">Financial Services Regulation
                                        Law
                                    </option>
                                    ...
                                    <option value="Land Use Law">Land Use Law</option>
                                    ...
                                    <option value="Security Law">Security Law</option>
