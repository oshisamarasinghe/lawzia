    ...
    <div class="row">
            ...
            <div class="col s12">
                ...
                <ul class="collapsible collapsible-accordion" data-collapsible="expandable">
                    <li>
                        <div class="collapsible-header cyan white-text active"><i class="mdi-action-account-circle"></i> Update Work Profile</div>
                        <div class="collapsible-body cyan lighten-5">
                            <p>It is always better to keep your professional profile updated<br>
                                Claiming your profile helps potential clients get to know you. Lawyers who have claimed their profiles are also eligible to participate in the LAWZIA Legal Answers community.<br>click the following link to update
                                <br><a href="lawyer-profile-update.php" class="purple-text">update profile now</a>
                            </p>
                        </div>
                    </li>
                    <li>
                        <div class="collapsible-header cyan white-text"><i class="mdi-action-question-answer"></i> Your Answers</div>
                        <div class="collapsible-body cyan lighten-5">
                            <p>
                               ssewf
                            </p>
                    ...
                    <li>
                        <div class="collapsible-header cyan white-text"><i class="mdi-action-face-unlock"></i>Profile Image Options</div>
                        <div class="collapsible-body cyan lighten-5">
