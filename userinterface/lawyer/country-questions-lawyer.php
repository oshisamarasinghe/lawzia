...
for ($page = 1; $page <= $no_of_pages; $page++) {
    if ($page == $page_no)
        echo '<li><a class="active waves-effect cyan" href="country-questions-lawyer.php?page=' . $page . '">' . $page . '</a></li>';
    else
        echo '<li><a class="waves-effect " href="country-questions-lawyer.php?page=' . $page . '">' . $page . '</a></li>';
