...
sHeaderTH:"",sFooterTH:"",sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sJUIHeader:"",sJUIFooter:""});var Da="",Da="",F=Da+"userinterface-state-default",ja=Da+"css_right userinterface-icon userinterface-icon-",Xb=Da+"fg-toolbar userinterface-toolbar userinterface-widget-header userinterface-helper-clearfix";h.extend(m.ext.oJUIClasses,m.ext.classes,{sPageButton:"fg-button userinterface-button "+F,sPageButtonActive:"userinterface-state-disabled",sPageButtonDisabled:"userinterface-state-disabled",sPaging:"dataTables_paginate fg-buttonset userinterface-buttonset fg-buttonset-multi userinterface-buttonset-multi paging_",
...
sHeaderTH:F,sFooterTH:F,sJUIHeader:Xb+" userinterface-corner-tl userinterface-corner-tr",sJUIFooter:Xb+" userinterface-corner-bl userinterface-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["previous","next"]},full:function(){return["first","previous","next","last"]},simple_numbers:function(a,b){return["previous",Wa(a,b),"next"]},full_numbers:function(a,b){return["first","previous",Wa(a,b),"next","last"]},_numbers:Wa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,e,d,f){var g=a.oClasses,i=
